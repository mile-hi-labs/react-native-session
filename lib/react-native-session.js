...
exports.withSession = exports.SessionProvider = exports.SessionContext = undefined;
...
var _asyncStorage = __webpack_require__(/*! @react-native-async-storage/async-storage */ "@react-native-async-storage/async-storage");
...
var SessionProvider = function (_Component) {
  ...
  _createClass(SessionProvider, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                _context.next = 10;
                return this.loadUser(store, this.state.modelName, userId, token, this.props.params);
    ...
    key: 'loadUser',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(store, modelName, modelId, token, params) {
        var _this2 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                user = _context2.sent;
                _context2.next = 7;
                return this.setState({ token: token, user: user }, function () {
                  return (0, _helpers.logger)('React Native Session: ', _this2.state);
                });
      ...
      function loadUser(_x, _x2, _x3, _x4, _x5) {
    ...
    key: 'authenticate',
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(modelName, data) {
        var store;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                store = this.props.store;
                _context3.next = 3;
                return _asyncStorage2.default.setItem('userId', data.id.toString());
              ...
              case 5:
                _context3.next = 7;
                return this.loadUser(store, modelName, data.id, data.token, {});
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                _context4.next = 4;
                return this.setState({ token: '', user: {} }, function () {
                  return function () {
                    return (0, _helpers.logger)('React Native Session: ', _this3.state);
                  };
                });
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          null,
          function (context) {
            return _react2.default.createElement(WrappedFunction, _extends({ session: context }, _this5.props));
          }
        );
      }
    }]);
