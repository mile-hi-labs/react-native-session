...
/* harmony import */ var deep_assign__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! deep-assign */ "./node_modules/deep-assign/index.js");
...
const mergeLocalStorageItem = (key, value) => {
  ...
  const nextValue = JSON.stringify(deep_assign__WEBPACK_IMPORTED_MODULE_0___default()({}, oldObject, newObject));
...
exports.withSession = exports.SessionProvider = undefined;
...
var _asyncStorage = __webpack_require__(/*! @react-native-async-storage/async-storage */ "./node_modules/@react-native-async-storage/async-storage/lib/module/index.js");

var _asyncStorage2 = _interopRequireDefault(_asyncStorage);

var _helpers = __webpack_require__(/*! utils/helpers */ "./src/utils/helpers.jsx");
...
var SessionContext = _react2.default.createContext();

var SessionProvider = function (_Component) {
  _inherits(SessionProvider, _Component);

  function SessionProvider(props) {
    _classCallCheck(this, SessionProvider);

    var _this = _possibleConstructorReturn(this, (SessionProvider.__proto__ || Object.getPrototypeOf(SessionProvider)).call(this, props));

    _this.state = {
      user: {},
      token: null,
      modelName: _this.props.modelName || 'user',
      loadUser: _this.loadUser.bind(_this),
      authenticated: _this.authenticated.bind(_this),
      authenticate: _this.authenticate.bind(_this),
  ...
  _createClass(SessionProvider, [{
    ...
    value: function componentDidMount() {
      (0, _helpers.logger)('React Native Session initiated...');
      this.init();
    }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _asyncStorage2.default.getItem('userId');

              case 2:
                userId = _context.sent;
                _context.next = 5;
                return _asyncStorage2.default.getItem('token');
    ...
    key: 'loadUser',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(modelName, modelId, token) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _context2.next = 7;
                return this.props.store.queryRecord(modelName, modelId, params);

              case 7:
                user = _context2.sent;

                (0, _helpers.logger)('Session authenticated: ', this.state);
                _context2.next = 11;
                return this.setState({ token: token, user: user });
    ...
    key: 'authenticate',
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(model, data) {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _asyncStorage2.default.setItem('userId', data.id);

              case 2:
                _context3.next = 4;
                return _asyncStorage2.default.setItem('token', data.token);

              case 4:
                _context3.next = 6;
                return this.loadUser(model, data.id, data.token, {});
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return _asyncStorage2.default.multiRemove(['userId', 'token']);

              case 2:
                _context4.next = 4;
                return this.setState({ token: '', user: {} });

              case 4:
                (0, _helpers.logger)('Session terminated: ', this.state);
...
var withSession = function withSession(WrappedFunction) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          null,
          function (context) {
            return _react2.default.createElement(WrappedFunction, _extends({ session: context }, _this3.props));
          }
        );
      }
    }]);
...
var _sessionContext = __webpack_require__(/*! contexts/session-context */ "./src/contexts/session-context.jsx");

exports.SessionProvider = _sessionContext.SessionProvider;
exports.withSession = _sessionContext.withSession;
...
exports.isEmpty = exports.logger = exports.timeElapsed = exports.removeObject = exports.addObject = undefined;

var _array = __webpack_require__(/*! lodash/array */ "./node_modules/lodash/array.js");

var _array2 = _interopRequireDefault(_array);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var addObject = exports.addObject = function addObject(array, record) {
	var newArray = !array.includes(record) ? array.push(record) : array;
	return array;
};

var removeObject = exports.removeObject = function removeObject(array, record) {
	var newArray = _array2.default.pull(array, record);
	return newArray;
};

var timeElapsed = exports.timeElapsed = function timeElapsed(msg, start) {
	if (true) {
...
/******/ });
//# sourceMappingURL=react-native-session.js.map